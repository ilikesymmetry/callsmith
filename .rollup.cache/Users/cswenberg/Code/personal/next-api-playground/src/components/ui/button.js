...
var Button = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx(Comp, __assign({ className: cn(buttonVariants({ variant: variant, size: size, className: className }), loading && "cursor-wait"), ref: ref, disabled: props.disabled || loading }, props)));
});
