...
var PathInput = function (_a) {
    ...
    return (_jsxs("div", { className: "inline-block relative p-1", children: [_jsx("input", __assign({ ref: hiddenInputRef, value: inputValue, readOnly: true, className: "absolute top-0 left-0 invisible h-0 overflow-hidden p-1" }, props)), _jsx("input", __assign({ value: inputValue, onChange: function (e) { return setInputValue(e.target.value); }, style: { width: "".concat(inputWidth, "px") }, className: "p-1 box-border dark:bg-neutral-900 ".concat(className) }, props))] }));
};
export { PathInput };
