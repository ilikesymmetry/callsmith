...
export function JsonEditor(_a) {
    ...
    return (_jsx(ReactCodeMirror, { value: value, onChange: onChange, theme: editorTheme, extensions: [json(), linter(jsonParseLinter())], editable: !disabled }));
}
