...
var TabsList = React.forwardRef(function (_a, ref) {
    ...
    return (<TabsPrimitive.List ref={ref} className={cn("flex flex-row w-full space-x-8 text-neutral-500 dark:text-neutral-400", className)} {...props}/>);
});
...
var TabsContent = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<TabsPrimitive.Content ref={ref} className={cn("mt-2 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300", className)} {...props}/>);
});
